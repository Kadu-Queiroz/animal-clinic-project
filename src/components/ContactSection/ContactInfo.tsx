      ...
      <div className="bg-white p-8 rounded-xl shadow-lg">
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold mb-2 text-[#002B3D]">Redes Sociais</h3>
              <div className="flex gap-3">
                <a
                  href="https://www.facebook.com/tokadospetsoficial"
                  className="bg-[#002B3D] text-white p-2 rounded-full hover:bg-blue-900 transition"
                >
