...
export function NavTabs() {
  ...
  const tabs = [
    { id: 'dashboard', label: 'Dashboard', icon: Home, href: '/tutor/dashboard' },
    { id: 'exames', label: 'Exames', icon: FileText, href: '/tutor/exames' },
    { id: 'historico', label: 'Histórico', icon: Clock, href: '/tutor/historico' },
  ];
